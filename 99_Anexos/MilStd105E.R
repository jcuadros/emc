...
#' <div style="margin-top:80px;color:#333333;">Agosto de 2018</div>
#' 
#' 
...
#' 
## ---- include = FALSE----------------------------------------------------
df105t2 <- read.table(file="105E_tab2.txt", sep=";", header=TRUE, quote="")
df105t2ls <- read.table(file="105E_tab2_ls.txt", sep=";", header=TRUE, quote="")
