...
Los procesos de certificación acreditada aportan la confianza:

- de que la organización tiene un sistema de gestión de calidad que cumple los requisitos aplicables de una norma, por ejemplo la ISO 9001.
- en la capacidad de la organización para, consecuentemente, suministrar productos que cumplan los requisitos de los clientes y los requisitos legales y reglamentarios.
